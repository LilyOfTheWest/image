...
struct qt_meta_stringdata_ImageResizer_t {
    QByteArrayData data[1];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ImageResizer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ImageResizer_t qt_meta_stringdata_ImageResizer = {
    {
QT_MOC_LITERAL(0, 0, 12) // "ImageResizer"
...
const QMetaObject ImageResizer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ImageResizer.data,
      qt_meta_data_ImageResizer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ImageResizer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ImageResizer.stringdata0))
